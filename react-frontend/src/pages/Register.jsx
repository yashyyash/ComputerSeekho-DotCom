...
//       } else {
//         alert("Registration succeeded but Student ID not returned. Cannot redirect.");
//         console.error("studentRes", studentRes);
//       }
//     } catch (error) {
...
//       // 3. Fetch all students and find the one matching the enquiryId
//       const allStudentsRes = await axios.get("http://localhost:8080/api/student");
//       const matchedStudent = allStudentsRes.data.find(
//         (student) => student.enquiry?.enquiryId === formData.enquiryId
//       );

//       if (matchedStudent?.studentId) {
//         alert("Student Registered Successfully");
//         navigate(`/student/${matchedStudent.studentId}`); // or `/payment/${matchedStudent.studentId}`
//       } else {
//         alert("Registration succeeded but Student ID not found. Cannot redirect.");
//         console.warn("No matching student found:", allStudentsRes.data);
//       }
//     } catch (error) {
//       alert("Student Registration Failed | Check if Already Registered");
//       console.error("Error registering student", error);
